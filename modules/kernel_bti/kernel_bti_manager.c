...
EXPORT_RESULT_STRUCT_SIZE() { return sizeof(kernel_bti_result_t); }

EXPORT_RESULT_STRUCT_DIAGNOSTICS(kernel_bti_result_t *result) {
  plog(INFO, "kernel_bti module called!");
