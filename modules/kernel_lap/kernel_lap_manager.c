...
EXPORT_RESULT_STRUCT_SIZE() { return sizeof(kernel_lap_result_t); }

EXPORT_RESULT_STRUCT_DIAGNOSTICS(kernel_lap_result_t *result) {
  plog(INFO, "kernel_lap module called!");
