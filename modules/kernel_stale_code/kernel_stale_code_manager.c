...
EXPORT_RESULT_STRUCT_SIZE() { return sizeof(kernel_stale_code_result_t); }

EXPORT_RESULT_STRUCT_DIAGNOSTICS(kernel_stale_code_result_t *result) {
  plog(INFO, "KERNEL stale_code_execution module called!");
