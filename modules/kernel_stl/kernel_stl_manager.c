...
EXPORT_RESULT_STRUCT_SIZE() { return sizeof(kernel_stl_result_t); }

EXPORT_RESULT_STRUCT_DIAGNOSTICS(kernel_stl_result_t *result) {
  plog(INFO, "kernel_stl module called!");
