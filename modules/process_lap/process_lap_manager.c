...
EXPORT_RESULT_STRUCT_SIZE() { return sizeof(process_lap_result_t); }

EXPORT_RESULT_STRUCT_DIAGNOSTICS(process_lap_result_t *result) {
  plog(INFO, "process_lap module called!");
