...
EXPORT_RESULT_STRUCT_SIZE() { return sizeof(process_lfb_result_t); }

EXPORT_RESULT_STRUCT_DIAGNOSTICS(process_lfb_result_t *result) {
  plog(INFO, "process_lfb module called!");
