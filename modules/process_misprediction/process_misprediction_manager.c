#include "../commands.h"
#include "process_misprediction_test.h"
...
EXPORT_RESULT_STRUCT_SIZE() { return sizeof(process_misprediction_result_t); }

EXPORT_RESULT_STRUCT_DIAGNOSTICS(process_misprediction_result_t *result) {
