...
EXPORT_RESULT_STRUCT_SIZE() { return sizeof(process_rsb_result_t); }

EXPORT_RESULT_STRUCT_DIAGNOSTICS(process_rsb_result_t *result) {
  plog(INFO, "process_rsb module called!");
