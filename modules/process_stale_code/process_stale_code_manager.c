#include "../commands.h"
#include "process_stale_code_test.h"
...
EXPORT_RESULT_STRUCT_SIZE() { return sizeof(process_stale_code_result_t); }

EXPORT_RESULT_STRUCT_DIAGNOSTICS(process_stale_code_result_t *result) {
  plog(INFO, "USER stale_code_execution module called!");
