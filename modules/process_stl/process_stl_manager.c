...
EXPORT_RESULT_STRUCT_SIZE() { return sizeof(process_stl_result_t); }

EXPORT_RESULT_STRUCT_DIAGNOSTICS(process_stl_result_t *result) {
  plog(INFO, "process_stl module called!");
