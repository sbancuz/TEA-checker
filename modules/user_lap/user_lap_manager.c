...
EXPORT_RESULT_STRUCT_SIZE() { return sizeof(user_lap_result_t); }

EXPORT_RESULT_STRUCT_DIAGNOSTICS(user_lap_result_t *result) {
  plog(INFO, "user_lap module called!");
