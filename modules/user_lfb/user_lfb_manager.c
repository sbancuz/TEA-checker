...
EXPORT_RESULT_STRUCT_SIZE() { return sizeof(user_lfb_result_t); }

EXPORT_RESULT_STRUCT_DIAGNOSTICS(user_lfb_result_t *result) {
  plog(INFO, "user_lfb module called!");
